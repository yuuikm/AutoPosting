...
import json
import random
from shared.config import EXCLUSIVE_ACCESS_TOKEN, EXCLUSIVE_FACEBOOK_PAGE_ID
...
def clean_source_spacing(text):
    return re.sub(r"(\b(?:Zakon\.kz|Informburo\.kz|Exclusive\.kz|Orda\.kz|Tengrinews\.kz)) \.", r"\1.", text)
...
def publish_to_facebook(image_url, post_url, text_content):
    try:
        ...
        upload_url = f"https://graph.facebook.com/v17.0/{EXCLUSIVE_FACEBOOK_PAGE_ID}/photos"
